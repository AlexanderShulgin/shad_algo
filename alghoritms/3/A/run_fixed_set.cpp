...
void RepeatInitialize() {
    ...
    int element = 0;
    int last = -1;
    for (int elements_count = 0; elements_count < (5 + 5); ++elements_count) {
...
void Magic() {
    ...
    int first = -1'000'000'000; // NOLINT
    int second = first + 2'000'000'000; //NOLINT
    FixedSet set;
